...
export { default as HOMEPAGE_LOGO_2 } from "./Home2.png";
export { default as HOMEPAGE_LOGO_3 } from "./Home3.png";
...
export { default as FOOTER_LOGO_3 } from './oyo.png';
export { default as FOOTER_LOGO_4 } from './rd.png';
export { default as FOOTER_LOGO_5 } from './airy.png';
export { default as FOOTER_LOGO_6 } from './bobobox.png';
